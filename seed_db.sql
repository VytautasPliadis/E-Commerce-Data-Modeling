...
-- added products
('2024-05-25 19:56:23', 'user_001', 'store_001', '{"Date": "2024-05-17 06:48:53", "payload": {"change": "add", "products": [{"Id": "101", "name": "Dress", "properties": {"size": "S", "color": "white"}}]}}'),
('2024-05-25 16:30:10', 'user_002', 'store_002', '{"Date": "2024-05-17 09:12:26", "payload": {"change": "add", "products": [{"Id": "122", "name": "Pants", "properties": {"size": "L", "color": "white"}}]}}'),
('2024-05-25 09:11:19', 'user_003', 'store_003', '{"Date": "2024-05-17 16:16:31", "payload": {"change": "add", "products": [{"Id": "115", "name": "Coat", "properties": {"size": "M", "color": "white"}}]}}'),
('2024-05-25 18:45:36', 'user_003', 'store_004', '{"Date": "2024-05-17 14:10:28", "payload": {"change": "add", "products": [{"Id": "118", "name": "Hat", "properties": {"size": "*", "color": "white"}}]}}'),
('2024-05-25 17:42:30', 'user_004', 'store_005', '{"Date": "2024-05-17 20:36:41", "payload": {"change": "add", "products": [{"Id": "198", "name": "Shoes", "properties": {"size": "43", "color": "white"}}]}}'),
-- removed/updated products
('2024-05-25 04:07:33', 'user_001', 'store_001', '{"Date": "2024-05-18 08:30:54", "payload": {"change": "update", "products": [{"Id": "100", "name": "T Shirt", "properties": {"size": "M", "color": "beige"}}]}}'),
('2024-05-25 04:07:33', 'user_002', 'store_002', '{"Date": "2024-05-17 08:30:54", "payload": {"change": "update", "products": [{"Id": "100", "name": "T Shirt", "properties": {"size": "XS", "color": "grey"}}]}}'),
